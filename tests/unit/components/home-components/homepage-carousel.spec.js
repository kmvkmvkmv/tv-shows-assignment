...
import HomepageCarousel from '../../../../src/components/home-components/HomepageCarousel.vue';
import VueRouter from 'vue-router'
import { routes } from '@/router/index';
import Vuex from 'vuex'

describe('In Homepage Carousel Component', () => {
    let wrapper;
    ...
    beforeEach(() => {
        ...
        wrapper = shallowMount(HomepageCarousel, {
            Vue,
            router,
            data() {
                return ({
    ...
    it('expected carousel stub', () => {
        const expected = '<v-carousel-stub';
